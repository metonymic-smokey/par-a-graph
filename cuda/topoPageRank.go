...
func pageRank(
	...
	fn, err := mod.Function("_Z5prGPUPdS_PxS0_S0_dS_xS_") //
	if err != nil {
		log.Fatalln("Cannot load function!: ", err)
	}

	fnLeak, err := mod.Function("_Z8calcLeakxPxPdS0_d")
	if err != nil {
	...
	for {
		...
		if err = fnLeak.LaunchAndSync(4, 1, 1, 256, 1, 1, 0, cu.Stream{}, argsLeak); err != nil {
		...
		if err = fn.LaunchAndSync(4, 1, 1, 256, 1, 1, 0, cu.Stream{}, args); err != nil {
